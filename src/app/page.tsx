  ...
  return (
    <main className="relative min-h-screen text-[var(--text)] selection:bg-emerald-400/30">
      ...
      <header className="sticky top-0 z-40 border-b border-[var(--border)] bg-[var(--header)]">
        <div className="mx-auto flex max-w-7xl flex-col gap-3 px-4 py-3 md:flex-row md:items-center md:justify-between md:gap-4 md:px-5 md:py-4">
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button
              ...
              className="inline-flex items-center gap-1.5 rounded-full border border-emerald-400/30 bg-emerald-400/10 px-3 py-2 text-xs font-semibold text-emerald-500 transition hover:bg-emerald-400/20"
            >
              📰<span className="hidden sm:inline">我的日报</span>
            </button>
            <KnowledgeBase />
            <TodoPanel />
            <MusicPlayer />
          ...
          <div className="flex flex-wrap items-center gap-2 md:gap-2.5">
            ...
            <a
              href="#heybox"
              className="rounded-full border border-[var(--border)] bg-[var(--surface)] px-3.5 py-2 text-xs font-semibold text-[var(--text)] transition hover:border-[var(--border-strong)] hover:bg-[var(--surface-hover)]"
            >
              黑盒<span className="hidden sm:inline">收藏</span>
            </a>
            <a
              href="#bili"
              className="rounded-full border border-[var(--border)] bg-[var(--surface)] px-3.5 py-2 text-xs font-semibold text-[var(--text)] transition hover:border-[var(--border-strong)] hover:bg-[var(--surface-hover)]"
            >
              B站<span className="hidden sm:inline">收藏</span>
            </a>
            <a
              href="/pid"
              className="rounded-full border border-emerald-400/30 bg-emerald-400/10 px-3.5 py-2 text-xs font-semibold text-emerald-500 transition hover:bg-emerald-400/20"
            >
              🎛️ PID<span className="hidden sm:inline">调试</span>
            </a>
            <a
      ...
      {/* ---------- AI RSS report (overlay, opened from the header) ---------- */}
      {reportOpen ? (
      <div id="rss" className="fixed inset-0 z-[60] flex flex-col bg-[var(--background)]">
        <div className="flex shrink-0 items-center justify-between gap-3 border-b border-[var(--border)] bg-[var(--header)] px-5 py-4">
          <div className="flex items-center gap-2">
            <span className="text-lg">📰</span>
            <h2 className="text-base font-semibold text-[var(--heading)]">我的 AI 日报</h2>
          </div>
          <button
            onClick={() => setReportOpen(false)}
            className="inline-flex items-center gap-1.5 rounded-full border border-[var(--border)] bg-[var(--surface)] px-4 py-2 text-xs font-semibold text-[var(--text)] transition hover:border-[var(--border-strong)] hover:bg-[var(--surface-hover)]"
          >
            ✕ 关闭
          </button>
        </div>
